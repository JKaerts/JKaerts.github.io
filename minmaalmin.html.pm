...
◊topic{Waarom is ◊${(-1)\times(-1)} gelijk aan ◊${1}?}
...
Het probleem zit hem echter in de vermenigvuldiging, want wat in godsnaam is het getal ◊${(-1)\times(-1)}?

Tegenwoordig krijgen leerlingen aangeleerd dat het antwoord ◊${1} is.
...
◊ul{
◊li{Commutativiteit: voor iedere twee natuurlijke getallen ◊${a} en ◊${b} zal ◊${a+b} gelijk zijn aan ◊${b+a} en zal ◊${a\times b} gelijk zijn aan ◊${b\times a}.}
◊li{Associativiteit: voor iedere drie natuurlijke getallen ◊${a}, ◊${b} en ◊${c} zal ◊${a+(b+c)} gelijk zijn aan ◊${(a+b) +c} en zal ◊${a\times (b\times c)} gelijk zijn aan ◊${(a\times b)\times c}.}
◊li{Distributiviteit: voor iedere drie natuurlijke getallen ◊${a}, ◊${b} en ◊${c} zal ◊${a\times(b+c)} gelijk zijn aan ◊${a\times b + a\times c}.}
}
